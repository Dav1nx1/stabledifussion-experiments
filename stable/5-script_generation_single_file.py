...
prompt='(masterpiece,  best quality,  dynamic angle),  full body shot,  (nsfw:1.4),  bend over,  kneeing,  from side,  Thomasin McKenzie,  yellow,  fishnet,  long sleeve,  scarf,  sneakers,  jewelery,  cape,  belt,  thigh straps,  gold,  colorful hair,  braids,  eyeliner,  makeup,  frowning,  fit,  large breasts,  long legs,  pussy,  (hips exposed,  pelvis exposed), (detailed face,  detailed eyes),  head tilt,  cave,  stream,  campfire,  tent,  food,  dark studio,  rim lighting,  two tone lighting,  dimly lit,  low key,  Ethnic Clothing,  jewelry,  traditional clothes, <lora:EMS-3108-EMS:0.600000>, , <lora:EMS-21551-EMS:0.700000>, , <lora:EMS-44624-EMS:0.400000>, , <lora:EMS-69762-EMS:0.600000>, , <lora:EMS-179-EMS:0.600000>, , <lora:EMS-22923-EMS:-0.800000>'

negative_prompt='ng_deepnegative_v1_75t,  badhandv4,  Asian-Less-Neg,  (loli),  young, thicc,  chubby,  fat, (worst quality:2),  (low quality:2),  (normal quality:2),  lowres,  bad anatomy,  bad hands,  multiple limbs,  extra limbs,  deformed limbs,  normal quality,  ((monochrome)),  ((grayscale)),  cum,  wet pussy'
...
model="../../2-models/raw/revAnimated_v122EOL.safetensors"
