...
from diffusers import DiffusionPipeline, AutoencoderKL, UniPCMultistepScheduler, DPMSolverMultistepScheduler, LCMScheduler, AutoPipelineForText2Image
...
image = pipe(prompt=prompt, num_inference_steps=5, guidance_scale=7).images[0]
